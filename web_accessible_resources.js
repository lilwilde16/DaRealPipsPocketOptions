...
window.addEventListener('message', function(ev) {
  ...
  if (!eng || !ws || typeof ws.send !== 'function') {
    console.warn('[MPB] demo test trade: engine or WebSocket not ready');
